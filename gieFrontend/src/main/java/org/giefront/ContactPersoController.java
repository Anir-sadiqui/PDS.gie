...
public class ContactPersoController {
    ...
    private void deletePersonne(Personne personne) {
        System.out.println("Deleting personne: " + personne.getNom());
        /*
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                contactService.deletePersonne(contact.getId());
                fetchContacts(null);
            }
        });
    ...
    public void switchToContactPerso(ActionEvent event) throws IOException {
